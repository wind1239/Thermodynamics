...
\begin{displaymath}
   ...
   \end{cases}
\end{displaymath}
thus the mixture with overall composition $z_{1},\cdots,z_{n{c}}$ is stable and must remain in the homogeneous state, otherwise the mixture is assumed unstable and will split into two phases -- liquid and vapour \citep[see][for further details of stability criteria]{michelsen_1984,michelsen_2007}.
\end{shaded}
