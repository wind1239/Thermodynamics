...
\vspace{3.5cm}
   ...
   {\bf{\Huge Integrated Multi-Fluid Flows Transport and Thermodynamic Models}}
...
\input{MainBoxFormulation}

%\input{Integrated_Compositional} % Compositional

\input{Hydrate_Formulation} % Simple Hydrate Model
\input{EOS_PR} % Simple Hydrate Model
...
%  \begin{appendix}
%     \input{Appendix_ConversionTable}
%     \input{Appendix_SaturatedTables}
%     \input{Appendix_LogTable}
%     \input{Appendix_Calculus1}
