    ...
    if iphase == 0:
       ...
       for i in range(nk):
           for j in range(nk):
               ...
               c2b = c2[ j ]; print c2b
               print
               MFrac[0] = c1b;     #print ' the MFrac[0] = ', MFrac[0]
               MFrac[1] = 1 - c1b; #print ' the MFrac[1] = ', MFrac[1]
               MFrac[2] = c2b;     #print ' the MFrac[2] = ', MFrac[2]
               MFrac[3] = 1 - c2b; #print ' the MFrac[3] = ', MFrac[3]
               print ' ------------------------------- '
...
###
'''
   Note that VapFrac, LiqFrac and Rub **must be** 2D arrays (i.e., matrix)
'''
fig = plt.figure()
